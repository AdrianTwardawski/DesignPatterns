...
namespace Adapter
{
    public class SmsSenderAdapter : INotificationSender //adapter, który spełnia interfejs INotificationSender
    {
        //przekształcenie zewnętrznego interfejsu do INotificationSender
